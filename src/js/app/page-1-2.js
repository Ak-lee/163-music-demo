    ...
    let model={
        ...
        find(){
            ...
            return query.find().then((songs)=>{
                songs.map(
                    (songItem)=>{
                        this.data.songs.push({id:songItem.id, name:songItem.attributes.name, singer:songItem.attributes.singer, url:songItem.attributes.url});
                    }
                );
                return this.data
            })
